...
export const BlogsData: BlogsPageDataType[] = [
  {
    "title": "The Complete Enterprise Guide to Three-Way Matching in Accounts Payable",
    "tag": "Technology",
    "summary": "Master three-way matching in accounts payable with our comprehensive 2025 guide. Learn implementation strategies, ROI benefits, automation tools, and best practices for fraud prevention and cost control.",
    "date": "July 8, 2025",
  ...
  {
    "title": "Smart Approvals in Finance: Revolutionizing Traditional Workflows with AI-Driven Intelligence",
    "tag": "AI in Finance",
    "summary": "Discover how smart approvals revolutionize finance workflows with AI automation, reducing approval times by 50% while improving compliance and strategic decision-making.",
    "date": "July 8, 2025",
    "read_time": "5 min read",

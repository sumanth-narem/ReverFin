          ...
          <div className='border-x border-primary-50 py-20 h-full w-full flex items-start justify-center flex-row overflow-hidden'>
            <div className='basis-1/2 px-10 overflow-y-auto'>
              {steps.map((step, index) => (
                <div
                  key={index}
                  className={`font-ppMori flex items-start justify-start flex-col border-t ${openIndex === index ? "border-primary-500" : "border-primary-50"} duration-500 transition-colors py-3`}
                >
